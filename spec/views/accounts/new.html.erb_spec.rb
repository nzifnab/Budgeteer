  ...
  context "New Account Form" do
    it "should render a form to create a new account" do
      ...
      response.should have_selector("form[method=post]", :action => accounts_path) do |form|
        form.should have_selector("input[type=submit]", :value => "Add Account")
      end
    end
    ...
    it "should render a text field for the account name" do
      ...
      response.should have_selector("form") do |form|
        form.should have_selector("input[type=text]", :name => "account[name]", :value => name)
      end
    end
    ...
    it "should render a select box for the account priority" do
      ...
      response.should have_selector("form") do |form|
        form.should have_selector("select", :name => "account[priority]") do |select|
    ...
    it "should render a text field for amount added per month" do
      ...
      render_new_account_page
      response.should have_selector("form") do |form|
        form.should have_selector("input[type=text]", :name => "account[add_per_month]", :value => add_per_month.to_s)
      end
    end
    ...
    it "should render a check box for adding monthly amounts by percent" do
      ...
      response.should have_selector("form") do |form|
        form.should have_selector("input[type=checkbox]", :name => "account[add_per_month_as_percent]", :value => add_per_month_as_percent.to_s)
      end
    end
    ...
    it "should render a check box for setting a cap on the account" do
      ...
      response.should have_selector("form") do |form|
        form.should have_selector("input[type=checkbox]", :name => "account[has_cap]", :value => has_cap.to_s)
      end
    end
    ...
    it "should render a field for the account cap" do
      ...
      response.should have_selector("form") do |form|
        form.should have_selector("input[type=text]", :name => "account[cap]", :value => cap.to_s)
      end
    end
    ...
    it "should render a check box for setting an account-adding prerequisite" do
      ...
      response.should have_selector("form") do |form|
        form.should have_selector("input[type=checkbox]", :name => "account[has_prerequisite]", :value => has_prerequisite.to_s)
      end
    end
    ...
    it "should render a select box for the account prerequisite" do
      ...
      response.should have_selector("form") do |form|
        form.should have_selector("select", :name => "account[prerequisite_id]") do |select|
          @accounts.each do |object|
            unless object == @prerequisite
              select.should have_selector("option", :value => object.id.to_s) do |option|
                option.should contain(object.name)
              end
            else
              select.should have_selector("option", :value => object.id.to_s, :selected => "selected") do |option|
                option.should contain(object.name)
              end
            end
          end
    ...
    it "should render a checkbox to enable the account" do
      ...
      response.should have_selector("form") do |form|
        form.should have_selector("input[type=checkbox]", :name => "account[enabled]", :value => enabled.to_s)
      end
    end
  end
end
